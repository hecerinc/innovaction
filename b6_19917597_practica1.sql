...
CREATE TABLE IF NOT EXISTS `Posee` (
  ...
  FOREIGN KEY (`IdCompetencia`) REFERENCES Competencias(`IdCompetencia`),
  FOREIGN KEY (`Nomina/Matricula`) REFERENCES Usuarios
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `Requiere` (
  ...
  FOREIGN KEY (`IdCompetencia`) REFERENCES Competencias,
  FOREIGN KEY (`IdSolicitudes`) REFERENCES Solicitudes
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `Colabora_en` (
  ...
  FOREIGN KEY (`Nomina/Matricula`) REFERENCES Usuarios,
  FOREIGN KEY (`IdProyecto`) REFERENCES Proyectos
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
